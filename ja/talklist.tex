\begin{rSection}{講演}
全51件のうち21件のトークを選出しました。
全リストは\href{https://github.com/git-sunao/cv/blob/main/ja/sunao_type_list.pdf}{こちら}をご覧ください。\begin{enumerate}[itemsep=0pt, parsep=0pt, topsep=0pt, partopsep=0pt]
\item \textbf{原始ブラックホールの観測的探査}, \href{https://indico.yukawa.kyoto-u.ac.jp/event/95/overview}{Progress in Partcles Physics}, 2026, Aug., \textit{Oral} (\textbf{Invited Talk})
