...
\begin{etaremune}
\setcounter{enumi}{52}
\item \textbf{Observational exploration of primordial black holes}, \href{https://indico.yukawa.kyoto-u.ac.jp/event/95/overview}{Progress in Partcles Physics}, 2026, Aug., \textit{Oral} (\textbf{Invited Talk})
\item \textbf{Probing Primordial Black Hole Dark Matter with Subaru HSC Microlensing Observations of M31}, \href{https://cosmophysics.gitlab.io/jointseminar.gitlab.io/sugiyama20260615.html}{IPNS Joint Experimental-Theoretica Cosmology Seminar}, 2026, Jun., \textit{Oral} (\textbf{Invited Talk})
\item \textbf{Searching for Primordial Black Holes with Microlensing Data from Subaru HSC}, \href{https://www.asiaa.sinica.edu.tw/activity/colloquium.php}{ASIAA colloquium}, 2026, Apr., \textit{Oral} (\textbf{Invited Talk})
\item \textbf{Cosmology from two- and three-point cosmic shear statistics}, Cosmology group meeting, 2026, Apr., \textit{Oral}
\item \textbf{Observational Search for Primordial Black Holes Using Subaru/HSC Microlensing}, \href{https://www-kam2.icrr.u-tokyo.ac.jp/event/19/}{Elucidating the Universe's Creation with Neutrinos based on International Science Collaborations}, 2026, Mar., \textit{Oral} (\textbf{Invited Talk})
\end{etaremune}
...
for Inference under Noisy Covariance}, \href{https://roman-hlis-cosmology.caltech.edu/news/2024-f2f}{Roman F2F meeting}, 2025, Nov., \textit{Oral}
\item \textbf{Cosmology from a joint analysis of second and third order shear statistics}, \href{https://astrophysics.uchicago.edu/events/event/2530/?past=y}{KICP seminar}, 2025, Oct., \textit{Oral}
...
\item \textbf{Probing Physics Beyond LambdaCDM: Precision Cosmology with Gaussian and Non-Gaussian Information from Subaru Data}, \href{https://www.ess.sci.osaka-u.ac.jp/researchers/seminar.html}{Earth and Space Science Seminar}, 2025, Jul., \textit{Oral}
\end{etaremune}
