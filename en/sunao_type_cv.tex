...
\address{{\bf CV}, Compiled on \today}

\begin{document}
\input{cv}
\begin{rSection}{List of publications, talks, and press releases}
    The list of publications, talks, and press releases is available \href{https://github.com/git-sunao/cv/blob/main/en/sunao_type_list.pdf}{here}.
\end{rSection}
\end{document}
