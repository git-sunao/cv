...
def wrap_cv_style(tex_in, language='en', fullauthor=False, space=55):
    ...
    if language == 'en':
        ...
        tex+= 'The up-to-date list of publication availabele at \\href{https://ui.adsabs.harvard.edu/search/p_=0&q=pubdate%3A%5B2001-01%20TO%209999-12%5D%20(%20%20%20%3Dauthor%3A%22Sugiyama%2C%20Sunao%22%20%20%20OR%20%20%20(%3Dauthor%3A%22Sugiyama%2C%20S%22%20AND%20%3Dauthor%3A%22Jain%2C%20B%22)%20)&sort=date%20desc%2C%20bibcode%20desc}{ADS}.\n'
        tex+= '\\vspace{-%dem}\n'%(space)
        tex+= '\\nobibliography{../publists/refs, ../publists/article}\n'
    else:
        tex = '\\begin{rSection}{出版/発表論文}\n'
        tex+= '最新の論文リストは\\href{https://ui.adsabs.harvard.edu/search/p_=0&q=pubdate%3A%5B2001-01%20TO%209999-12%5D%20(%20%20%20%3Dauthor%3A%22Sugiyama%2C%20Sunao%22%20%20%20OR%20%20%20(%3Dauthor%3A%22Sugiyama%2C%20S%22%20AND%20%3Dauthor%3A%22Jain%2C%20B%22)%20)&sort=date%20desc%2C%20bibcode%20desc}{ADS}を参照ください。'
        tex+= '\\vspace{-%dem}\n'%space
        tex+= '\\nobibliography{../publists/refs, ../publists/article}\n'
